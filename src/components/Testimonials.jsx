...
function Testimonials() {
    return (
        <section id="clients" className={`${styles.paddingY} ${styles.flexCenter} flex-col relative`}>
            ...
            {/* Title and Subtitle */}
            <div className="w-full flex justify-between items-start flex-col mb-6 ss:mb-8 sm:flex-row sm:justify-center sm:items-center relative z-[1] gap-x-[2em]">
            ...
            {/* Feedback Cards */}
            <div className="flex flex-col w-full justify-start items-center sm:flex-row sm:justify-center sm:items-center sm:flex-wrap md:justify-between feedback-container relative z-[1] gap-8">
