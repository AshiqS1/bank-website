        ...
        <nav className="w-full flex py-6 justify-between items-center navbar">
            ...
            <ul className="list-none sm:flex hidden justify-end items-center flex-1">
                {navLinks.map((navLink, idx) => (
                    <li key={navLink.id} className={`font-poppins font-normal cursor-pointer text-[16px] text-white ${idx === navLinks.length - 1 ? "mr-0" : "mr-10"} pt-[5px] hover:text-secondary`}>
            ...
            <div className="sm:hidden flex flex-1 justify-end items-center">
                ...
                <div className={`${toggleNav ? "flex" : "hidden"} p-6 bg-black-gradient absolute top-20 right-0 mx-4 my-2 min-w-[140px] rounded-xl sidebar`}>
